...
public class JintRuntimeTests
{
    ...
    internal static (JintRuntime, TestContext) CreateRuntime()
    {
        ...
        var modules = new IJintApiModule[]
        {
            ...
            new WorldModule(messaging, worldOps, world, gameLoop, new ClassRegistry(), new RaceRegistry(), mobAIManager, new NullGmcpModuleAdapter(), new TagRegistry(), new Tapestry.Engine.Persistence.PropertyRegistry(), new Tapestry.Engine.Mapping.AreaMapProjector(world, new Tapestry.Engine.Tags.TagRegistry()), new Tapestry.Engine.Mapping.AsciiMapRenderer(), spawnManager),

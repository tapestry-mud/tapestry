...
public static class CommonProperties
{
    ...
    public static void Register(PropertyRegistry registry)
    {
        ...
        registry.RegisterEngineProperty(LastTellFrom, "Last entity who sent a tell to this player", PropertyValueType.String, appliesTo: new[] { "player" });
        registry.RegisterEngineProperty(LastTellTo, "Last entity this player sent a tell to", PropertyValueType.String, appliesTo: new[] { "player" });
